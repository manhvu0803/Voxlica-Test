Shader "Fraktalia/Core/MultiTexture_V2/Texture2D_UVBlend_8Layers"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        // New Diffuse Maps
        UNITY_DECLARE_TEX2D(_DiffuseMap4);
        ...
        // New Metallic Maps
        UNITY_DECLARE_TEX2D(_MetallicGlossMap4);
        ...
        // New Parallax Maps
        UNITY_DECLARE_TEX2D(_ParallaxMap4);
        ...
        // New Occlusion Maps
        UNITY_DECLARE_TEX2D(_OcclusionMap4);
        ...
        // New Emission Maps
        UNITY_DECLARE_TEX2D(_EmissionMap4);
        ...
        struct Input
        {
            ...
            float4 texcoord2;
            float4 texcoord3; //2 at end to match defined _IndexTex2 to prevent redefinition
            float3 viewDir;        
            INTERNAL_DATA
        };
